...
2. Rename it something like **"Jessica Voigt Campaign — Signups"**.
...
- If you ever edit `Code.gs` again, you need to **Deploy → Manage
  ...
  enough.
- Your donation processor (Anedot/ActBlue/WinRed) is unrelated to this —
  that's a separate account with its own notification settings, not
